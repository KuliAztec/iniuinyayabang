@extends('layouts.app')
@section('title', 'Profile - Hogwarts School of Witchcraft and Wizardry')
@section('content')
...
<!--DESCRIPTION SECTION-->
<section class="py-12 md:py-16 lg:py-20 bg-gradient-to-br from-white via-blue-50 to-white">
...
<section class="py-16 bg-gradient-to-r from-blue-50 via-blue-100/50 to-blue-50">
    <div class="container mx-auto px-4">
...
<!--PURPOSE SECTION-->
<section class="py-16 bg-gradient-to-tl from-white via-blue-50 to-white">
    <div class="container mx-auto px-4">
...
<section class="py-16 bg-gradient-to-tr from-blue-100/70 via-blue-50 to-blue-100/50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-blue-950 relative inline-block pb-2">
